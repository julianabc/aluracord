...
import { ButtonSendSticker } from '../src/components/ButtonSendSticker'; // biblioteca de stickers
...
export default function ChatPage() {
  ...
  const usuarioLogado = roteamento.query.username; // pegar o usuario que está passando pela url 
